...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'project-b04-65682dfc59cc.herokuapp.com', '.herokuapp.com', '0.0.0.0']
...
WSGI_APPLICATION = 'studyspot.wsgi.application'
